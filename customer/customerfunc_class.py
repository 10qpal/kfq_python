...
class Customer:
    def insertData(self, page, custlist):       # 매개변수 page, custlist를 받음        
        print("고객 정보 입력")
    ...
    def curSearch(self, page, custlist):
        print("현재 고객 정보 조회")
        if page>0:
    ...
    def preSearch(self, page, custlist):
        print("이전 고객 정보 조회")
        if page<=0:
    ...
    def nextSearch(self, page, custlist):
        print("다음 고객 정보 조회")
